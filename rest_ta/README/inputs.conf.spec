...
*Full path to your CA Bundle , https://requests.readthedocs.io/en/master/user/advanced/#ssl-cert-verification
ca_bundle_path= <value>

*full path to your client certificate
client_cert_path= <value>

*full path to your unencrypted private key
client_key_path= <value>

*Alternatively to declaring your certificate and key seperately above , you can enter the full path to your bundled client certificate/unencrypted private key file
